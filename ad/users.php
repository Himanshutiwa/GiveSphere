                    ...
                    <div class="col-12">
                        <div class="table-container">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <a href="user-add.php" class="btn btn-outline-primary btn-sm">Add User</a>
                            </div>
                                    ...
                                    <tbody>
                                       ...
                                       ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="user-edit.php?id=<?= $result['id']?>"><i class="fa fa-edit px-2 text-success"></i></a>
                                                <a href="user-delete.php?id=<?= $result['id']?>"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                        <?php
                                            }
