...
<head>
    ...
    <title> User Add  - Admin Panel</title>
        ...
        <div class="col-md-7"> <!-- Width thoda badhaya taaki buttons fit aayein -->
            <div class="card shadow-lg">
                <div class="card-header bg-primary text-white">
                    <h4 class="mb-0"><i class="fas fa-user-add"></i> Add User Details</h4>
                </div>
                <div class="card-body p-4">
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text bg-light"><i class="fas fa-add"></i></span>
                                <input type="text" name="password" value="<?= $phone; ?>" class="form-control">
                            </div>
                        </div>
                        <!-- BUTTONS SECTION -->
                        <div class="d-flex justify-content-between align-items-center mt-4 pt-2 border-top">
                            ...
                            <div>
                                ...
                                <button type="submit" name="update_btn" class="btn btn-success">
                                    Add User <i class="fas fa-save"></i>
                                </button>
                            </div>
                        </div>
                        <!-- End Buttons -->
